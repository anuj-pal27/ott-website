  ...
  return (
    <div className="dashboard-theme">
      ...
      <div className="dashboard-content" id="products-section">
        ...
        <div className="max-w-4xl mx-auto mb-12 p-8 rounded-3xl shadow-2xl border border-gray-200 text-left flex flex-col md:flex-row gap-8 items-center relative overflow-hidden group transition-all duration-300 hover:shadow-lg hover:scale-[1.01] bg-white">
          <div className="flex-shrink-0 flex flex-col items-center justify-center w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 border-4 border-primary/30 shadow-xl mr-0 md:mr-8 relative z-10">
            <span className="text-6xl md:text-7xl text-primary drop-shadow-lg">🚚</span>
          </div>
          <div className="flex-1">
            <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-6 tracking-wide text-center md:text-left">How We Deliver Our Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 hover:bg-gray-100 transition-all duration-300">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">As soon as you place your order and complete the payment, our system begins processing your request automatically within seconds.</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 hover:bg-gray-100 transition-all duration-300">
                <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                  <span className="text-xl">📱</span>
                ...
                <p className="text-gray-600 text-sm leading-relaxed">Your service details, activation codes, or access credentials are delivered directly to your registered mobile number via WhatsApp or SMS—usually within <span className="font-bold text-primary">30 minutes</span> of your order.</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 hover:bg-gray-100 transition-all duration-300">
                <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                  <span className="text-xl">🔔</span>
                ...
                <p className="text-gray-600 text-sm leading-relaxed">You'll receive notifications at every step of the process, so you always know the status of your order and when to expect delivery.</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 hover:bg-gray-100 transition-all duration-300">
                <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                  <span className="text-xl">🔒</span>
                ...
                <p className="text-gray-600 text-sm leading-relaxed">All deliveries are handled securely with end-to-end encryption, and your personal information is kept completely confidential.</p>
              </div>
            </div>
            <div className="bg-gradient-to-r from-blue-50 to-green-50 border-l-4 border-primary rounded-lg p-4 text-sm text-gray-700 font-semibold mb-4">
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-400 rounded-lg p-4 text-sm text-gray-700 font-semibold italic shadow-sm">
              <span className="text-yellow-600 font-bold">Note:</span> In rare cases, delivery may take slightly longer due to high demand or technical issues, but we strive to fulfill every order as quickly as possible. Most orders are delivered within 30 minutes!
            </div>
          </div>
        </div>
      </div>
